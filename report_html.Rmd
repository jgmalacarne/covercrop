...
nccTable <- kbl(nccTableData, format = "html", linesep = " ", align = "lclll", caption = "Enterprise Budget") %>%
  row_spec(c(0), bold = T, font_size = 20, extra_css = "border-bottom: 2px solid;") %>%
...
direct_comparison_table <- kbl(direct_comparison_data, format = "html", booktabs = T, linesep = " ", align = "lccc", caption = "Direct Comparison of Cover Crop Strategies") %>%
  row_spec(c(0), bold = T, font_size = 20, extra_css = "border-bottom: 2px solid;") %>%
  kable_classic(full_width = F)
...
fallowccTable <- kbl(fcTableData, format = "html", booktabs = T, linesep = " ", align = "lclll", caption = "No Cover Crop Enterprise Budget") %>%
  row_spec(c(0), bold = T, font_size = 20, extra_css = "border-bottom: 2px solid;") %>%
...
interseedingccTable <- kbl(icTableData, format = "html", booktabs = T, linesep = " ", align = "lclll", caption = "Interseeding Enterprise Budget") %>%
  row_spec(c(0), bold = T, font_size = 20, extra_css = "border-bottom: 2px solid;") %>%
...
lateSeasonccTable <- kbl(lcTableData, format = "html", booktabs = T, linesep = " ", align = "lclll", caption = "Fall Cover Crop Enterprise Budget") %>%
  row_spec(c(0), bold = T, font_size = 20, extra_css = "border-bottom: 2px solid;") %>%
  row_spec(c(which(icTableData$Item %in% bold_rows)), bold = T) %>%
  row_spec(c(which(icTableData$Item %in% underline_rows)), extra_css = "border-bottom: 1px solid;") %>%
  row_spec(c(which(icTableData$Item %in% header_rows)), font_size = 16) %>%
